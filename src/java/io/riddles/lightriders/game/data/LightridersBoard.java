...
public class LightridersBoard extends Board {
    ...
    public String toRepresentationString(ArrayList<LightridersPlayer> players, LightridersState state) {
        ArrayList<Enemy> enemies = state.getEnemies();
        String output = "";
        int counter = 0;
        for (int y = 0; y < this.height; y++) {
    ...
    public void updateComplete(ArrayList<LightridersPlayer> players, LightridersState state) {
        ArrayList<Enemy> enemies = state.getEnemies();
        for (int y = 0; y < this.height; y++) {
            for (int x = 0; x < this.width; x++) {
    ...
    public Coordinate getLoneliestField(ArrayList<LightridersPlayer> players) {
